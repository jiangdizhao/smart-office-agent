...
def test_http_and_websocket_contract() -> None:
    ...
    with TestClient(app) as client:
        ...
        assert client_state.json()["schema_version"] == "phase5.1"
        ...
        with client.websocket_connect("/ws/v1/events") as websocket:
            ...
            assert initial_client_state["payload"]["schema_version"] == "phase5.1"
            ...
            assert refreshed["payload"]["schema_version"] == "phase5.1"
